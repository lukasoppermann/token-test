...
// Generated on Tue, 13 Oct 2020 10:24:27 GMT
//
...
public class StyleDictionary {
    public static let internalH1FontFamily = Roboto
    public static let internalH1FontSize = 10
    public static let internalH1FontStyle = Medium
    public static let internalH1LetterSpacing = 0
    public static let internalH1LineHeight = normal
    public static let internalH1ParagraphIndent = 0
    public static let internalH1ParagraphSpacing = 0
    public static let internalH1TextCase = none
    public static let internalH1TextDecoration = none
    public static let invalidBecauseOfAlignment = max
    public static let invalidBecauseOfCount = 5
    public static let invalidBecauseOfGutterSize = 13
    public static let invalidBecauseOfOffset = 23
    public static let invalidBecauseOfPattern = columns
    public static let invalidBecauseOfSectionSize = 21
    public static let invalidOrange = rgba(255, 128, 64, 1)
    public static let tokencolorInvalid = rgba(254, 80, 80, 1)
    public static let tokencolorValid = rgba(66, 231, 132, 1)
