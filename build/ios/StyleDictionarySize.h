...
extern float const InvalidBecauseOfSectionSize;
extern float const InvalidBecauseOfGutterSize;
extern float const InvalidBecauseOfCount;
extern float const InvalidBecauseOfOffset;
extern float const InternalH1FontSize;
extern float const InternalH1LetterSpacing;
extern float const InternalH1ParagraphIndent;
extern float const InternalH1ParagraphSpacing;
